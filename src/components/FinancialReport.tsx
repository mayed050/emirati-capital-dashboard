    ...
    <div className="grid min-w-0 grid-cols-[minmax(0,1fr)] gap-5">
      <div className="no-print flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">تنسيق CSS Print-Friendly لكل الأسهم في قاعدة منصة الأسهم الإماراتية.</p>
        </div>
        <button
          type="button"
      ...
      <article className="print-page glass-panel rounded-lg bg-white p-6">
        ...
        <section className="mt-5 grid gap-3 md:grid-cols-4">
          ...
          <Metric label="أعلى عائد للقادة" value={`${topYield[0].symbol} ${formatPlainPercent(topYield[0].fundamentals.dividendYield)}`} />
        </section>

        <section className="mt-6">
          <h3 className="mb-3 text-xl font-black text-slate-950">أعلى العوائد النقدية بين قادة السوق</h3>
